...
public class Frag09 extends Fragment05 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view=inflater.inflate(R.layout.activity_frag09,container,false);
        a=view.findViewById(R.id.tel);
        b=view.findViewById(R.id.b9tn);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tel = a.getText().toString();
                List<Custom> customList = DataSupport.select("id").where("telephone = ?",tel).find(Custom.class);
